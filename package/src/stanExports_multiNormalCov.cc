...
#include "stanExports_multiNormalCov.h"

RCPP_MODULE(stan_fit4multiNormalCov_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_multiNormalCov")
