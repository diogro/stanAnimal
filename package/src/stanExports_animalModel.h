...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("a_tilde", "(N * K)", (N * K));
        context__.validate_dims("parameter initialization", "a_tilde", "vector_d", context__.to_vec((N * K)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_tilde((N * K));
        size_t a_tilde_j_1_max__ = (N * K);
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_tilde = in__.vector_constrain((N * K));
        size_t a_tilde_j_1_max__ = (N * K);
        for (size_t j_1__ = 0; j_1__ < a_tilde_j_1_max__; ++j_1__) {
