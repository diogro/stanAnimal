...
#include "stanExports_animalModelUni.h"

RCPP_MODULE(stan_fit4animalModelUni_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_animalModelUni")
